...
$vmList.ForEach({ 
   ...
   $EventHubResourceGroupName = "ITCORP-SECURITYLOGS-RGRP"
   $EventHubNamespace = "ITCORP-" + $locID + "-EVENTHUBNS01"
   $EventHubName = "general"
   $EventHubSharedAccessKeyName = "Listen"
   $EventHubSubId = "2688de0d-7b76-4095-b806-26790200773b"
 ...
 #VM variables
   ...
   $storageAccountName = $locID + "ryansiemdiaglogs"
   $storageAccountResourceGroup = "WTW-ITCORP-POCLAB-NA20-RGRP-Ryantest"
